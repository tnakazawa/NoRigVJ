...
- エントリは `control.html`(操作UI)/ `display.html`(投影窓)の2つ([specs/001-multi-window-projection.md](specs/001-multi-window-projection.md)参照)。詳細(状態管理・BroadcastChannel・操作方法)は [src/CLAUDE.md](src/CLAUDE.md) を参照。
