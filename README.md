...
投影窓ごとに、メイン/サブの2色からなるカラーパレットを設定できます。32種類のプリセットから選ぶか、カラーピッカーで自由に配色できます。プリセット選択のドロップダウンは各項目の左にmain/subの色見本が並んでおり、選ばなくても一覧から色味を確認できます。パレット非対応のシーン(Bar Spectrum)を選んでいる間は、パレットUIが無効化されます。
