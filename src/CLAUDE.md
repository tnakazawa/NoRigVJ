...
| 投影窓ごとのシーンプリセットUI | 現在のシーン名+パレットを名前付きで保存/呼び出し/削除。`localStorage` に永続化され、全投影窓行で共有される([../specs/005-scene-presets.md](../specs/005-scene-presets.md)参照) |
